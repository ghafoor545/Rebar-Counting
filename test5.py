...
# Paths
model_path = "/home/nutech/Downloads/best1.pt"        # your model
image_path = "/home/nutech/Downloads/image1.jpeg"     # your image

# Load model
model = YOLO(model_path)

# Run inference (CPU, safe for high counts)
...
# Apply max limit logic
if total_rebars > 1000:
    total_rebars = 1000

print(f"Detected Rebars (max 1000): {total_rebars}")
